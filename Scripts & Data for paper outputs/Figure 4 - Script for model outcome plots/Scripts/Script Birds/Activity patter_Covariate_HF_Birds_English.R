...
Data_E <- subset(Data, Data$Species == "Catharus_ustulatus") # Decide which Species to test
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("Swainsons thrush")), cex.lab=2, cex.axis=1.2, ylab = "Diurnality",
...
Data_E <- subset(Data, Data$Species == "Crypturellus_soui") # Decide which Species to test
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("Little tinamou")), cex.lab=2, cex.axis=1.2, ylab = "Diurnality",
     ylim = c(-0.1,1.1), yaxt = "n", lwd = 2, font.lab=2) 
lines(plot_X$Disturbance, prd.model$fit - 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
lines(plot_X$Disturbance, prd.model$fit + 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
axis(side = 2, at= seq(0,1,0.25), labels = seq(0,1,0.25), cex.axis=1.2)
...
Data_E <- subset(Data, Data$Species == "Nyctidromus_albicollis") # Decide which Species to test
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("Pauraque")), cex.lab=2, cex.axis=1.2, ylab = "Diurnality",
     ylim = c(-0.1,1.1), yaxt = "n", lwd = 2, font.lab=2) 
lines(plot_X$Disturbance, prd.model$fit - 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
lines(plot_X$Disturbance, prd.model$fit + 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
axis(side = 2, at= seq(0,1,0.25), labels = seq(0,1,0.25), cex.axis=1.2)
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("Nyctidromus albicollis")), cex.lab=2, cex.axis=1.2, ylab = "Diurnality",
     ylim = c(-0.1,1.1), yaxt = "n", lwd = 2, font.lab=2) 
lines(plot_X$Disturbance, prd.model$fit - 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
lines(plot_X$Disturbance, prd.model$fit + 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
axis(side = 2, at= seq(0,1,0.25), labels = seq(0,1,0.25), cex.axis=1.2)
...
Data_E <- subset(Data, Data$Species == "Leptotila_verreauxi") # Decide which Species to test
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("White-tipped dove")), cex.lab=2, cex.axis=1.2, ylab = " ",
     ylim = c(-0.1,1.1), yaxt = "n", lwd = 2, font.lab=2) 
lines(plot_X$Disturbance, prd.model$fit - 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
lines(plot_X$Disturbance, prd.model$fit + 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
axis(side = 2, at= seq(0,1,0.25), labels = seq(0,1,0.25), cex.axis=1.2)
...
Data_E <- subset(Data, Data$Species == "Momotus_momota") # Decide which Species to test
...
plot(plot_X$Disturbance, prd.model$fit, type = "l",xlab = expression(italic("Amazonian motmot")), cex.lab=2, cex.axis=1.2, ylab = " ",
     ylim = c(-0.1,1.1), yaxt = "n", lwd = 2, font.lab=2) 
lines(plot_X$Disturbance, prd.model$fit - 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
lines(plot_X$Disturbance, prd.model$fit + 1.96 * prd.model$se.fit, lty = 2, col = "darkgray", lwd = 2) 
axis(side = 2, at= seq(0,1,0.25), labels = seq(0,1,0.25), cex.axis=1.2)
